  ...
  render() {
    return (
      <main className="w-full ">
        <section className="flex bg-Green lg:px-60 lg:gap-10 md:items-center md:justify-center xl:px-0 xl:justify-evenly">
          <Hero_title />
          <img
        ...
        >
          <div className="flex flex-col items-center justify-between lg:flex-row lg:w-full ">
            <h2 className="w-3/4 font-extrabold text-center text-sub_title text-Black font-Karla-extraBold lg:w-auto">
              This Weeks Specials!!
            </h2>
        ...
        <section className="flex flex-col items-center justify-center py-4 bg-Green lg:px-60 lg:py-20 ">
          <h2 className="w-3/4 text-4xl font-medium text-center text-Yellow font-Markazi-medium">
            Testimonials
          </h2>
