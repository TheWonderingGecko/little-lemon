  ...
  render() {
    return (
      <main className=" w-full">
        ...
        <section className="flex flex-col items-center justify-center bg-Green py-4 md:px-60 md:py-20  ">
        ...
        <section
          className=" md:hidden flex flex-col items-center justify-center px-4  py-4 "
          id="about"
        >
        ...
        <section
          className=" hidden w-full  md:flex  items-center justify-between px-60  py-20  h-full md:relative gap-8"
          id="about"
        >
          <div className="w-[370px] basis-1/2">
            ...
            <p className="text-Black text-medium font-Karla-bold font-bold">
              Little Lemon is owned by two Italian brothers, Mario and Adrian,
              who moved to the United States to pursue their shared dream of
              owning a restaurant. To craft the menu, Mario relies on family
              recipes and his experience as a chef in Italy. Adrian does all the
          ...
          <div className="flex flex-col basis-1/2 ">
            <img
              className=" absolute z-10 top-[5%] right-[18%] object-cover w-[276px] h-[338px] shadow-md  border  border-black "
              src={about_img}
              alt="Image 1"
            />
